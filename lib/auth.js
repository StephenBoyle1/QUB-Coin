...
function initContract(){
    if(!QUB_COIN_ADDRESS || QUB_COIN_ADDRESS == ''){
        ...
        var qubCoinAbi = [{"constant":true,"inputs":[],"name":"creator","outputs":[{"name":"","type":"address"}],"type":"function"},{"constant":false,"inputs":[{"name":"accountId","type":"address"},{"name":"email","type":"bytes32"},{"name":"name","type":"bytes32"},{"name":"isStudent","type":"bool"}],"name":"createUser","outputs":[],"type":"function"},{"constant":true,"inputs":[{"name":"","type":"uint256"}],"name":"classesAddresses","outputs":[{"name":"","type":"address"}],"type":"function"},{"constant":true,"inputs":[{"name":"","type":"uint256"}],"name":"instructorsAddresses","outputs":[{"name":"","type":"address"}],"type":"function"},{"constant":true,"inputs":[{"name":"","type":"address"}],"name":"classes","outputs":[{"name":"","type":"address"}],"type":"function"},{"constant":false,"inputs":[{"name":"_studentId","type":"address"},{"name":"_classId","type":"address"}],"name":"enrollStudentToClass","outputs":[],"type":"function"},{"constant":true,"inputs":[{"name":"_classId","type":"address"}],"name":"getClassAtAddress","outputs":[{"name":"instructor","type":"address"},{"name":"name","type":"bytes32"},{"name":"location","type":"bytes32"},{"name":"startTime","type":"bytes32"},{"name":"duration","type":"uint8"},{"name":"date","type":"bytes32"},{"name":"theClassType","type":"bytes32"},{"name":"classAddress","type":"address"}],"type":"function"},{"constant":true,"inputs":[],"name":"numOfInstructors","outputs":[{"name":"","type":"uint256"}],"type":"function"},{"constant":false,"inputs":[{"name":"_instructor","type":"address"},{"name":"_name","type":"bytes32"},{"name":"_location","type":"bytes32"},{"name":"_startTime","type":"bytes32"},{"name":"_duration","type":"uint8"},{"name":"_date","type":"bytes32"},{"name":"_classType","type":"bytes32"}],"name":"createClass","outputs":[],"type":"function"},{"constant":true,"inputs":[{"name":"_accountId","type":"address"},{"name":"_index","type":"uint256"}],"name":"getClassAtIndex","outputs":[{"name":"instructor","type":"address"},{"name":"name","type":"bytes32"},{"name":"location","type":"bytes32"},{"name":"startTime","type":"bytes32"},{"name":"duration","type":"uint8"},{"name":"date","type":"bytes32"},{"name":"theClassType","type":"bytes32"},{"name":"classAddress","type":"address"}],"type":"function"},{"constant":true,"inputs":[],"name":"numOfStudents","outputs":[{"name":"","type":"uint256"}],"type":"function"},{"constant":true,"inputs":[{"name":"","type":"address"}],"name":"users","outputs":[{"name":"accountId","type":"address"},{"name":"email","type":"bytes32"},{"name":"name","type":"bytes32"},{"name":"attendanceBalance","type":"uint256"},{"name":"feedbackBalance","type":"uint256"},{"name":"isStudent","type":"bool"},{"name":"isAdmin","type":"bool"},{"name":"numOfClasses","type":"uint256"}],"type":"function"},{"constant":true,"inputs":[{"name":"","type":"bytes32"}],"name":"registeredEmails","outputs":[{"name":"","type":"address"}],"type":"function"},{"constant":true,"inputs":[],"name":"numOfClasses","outputs":[{"name":"","type":"uint256"}],"type":"function"},{"constant":true,"inputs":[{"name":"","type":"uint256"}],"name":"studentsAddresses","outputs":[{"name":"","type":"address"}],"type":"function"},{"inputs":[],"type":"constructor"}];
 ...
 */
function registerUser(name, email, secret, isStudent, callback) {
    try{
        ...
        if(userAddress && userAddress != NULL_ADDRESS){
            ...
            var txnHash = qubCoin.createUser(newAddress, email, name, isStudent,
