...
var QUB_COIN_ADDRESS = '0xf7b5aa57b73e1cd609992b0256556c5d84653606';
...
function initContract(){
  ...
  var qubCoinAbi = [
    {
      ...
      "outputs":[
        ...
        {"name":"coinBalance","type":"uint256"}
      ],
      "type":"function"
    },
    {"constant":true,"inputs":[],"name":"numInstructors","outputs":[{"name":"","type":"uint256"}],"type":"function"},
  ...
  var numOfIns = qubCoin.numInstructors();
...
function callGetInstructor(forAddress){
  ...
  return {
    ...
    email: instructor[1].toString(),
    name: instructor[2].toString(),
